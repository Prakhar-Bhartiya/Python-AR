...
def markerDetetcion_Augmentation(frame, source, cornerIDs, useCache=False):
...
#         imageMultiplied = cv2.multiply(frame.copy(), 1.0 - maskScaled)
#         # output = cv2.add(warpedMultiplied, imageMultiplied)
#         # output = warpedMultiplied
#         output = imageMultiplied
